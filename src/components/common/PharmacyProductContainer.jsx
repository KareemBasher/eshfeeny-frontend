...
const PharmacyProductContainer = ({ onGetProduct, loggedInUser, favorites }) => {
  ...
  return (
    <div className="flex flex-col justify-between rounded-lg hover:shadow-xl transition-all duration-300 shadow-sm w-[250px] h-[380px] border-[#E7E7E7] border-[0.8px] mx-2 my-4">
      <button
